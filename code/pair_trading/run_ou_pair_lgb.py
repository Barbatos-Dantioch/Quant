...
# -*- coding: utf-8 -*-
"""
OU 配对·LightGBM 信号实验 (OU-P-RPL-LGB-cv5-h5)
================================================

与 OU-P-RPL-XGB-cv5-h5 完全一致, 仅训练算法从 XGBoost 换成 LightGBM.
其它: 同样 28 特征, 5 段半年 rolling, train/val 80/20 + 5 日 gap,
